...
public class Task extends org.jooq.impl.TableImpl<models.generated.mysql.tables.records.TaskRecord> {
	...
	private static final long serialVersionUID = -1375802672;
	 ...
	 */
	public final org.jooq.TableField<models.generated.mysql.tables.records.TaskRecord, java.lang.Long> ID = createField("id", org.jooq.impl.SQLDataType.BIGINT, this);
	 ...
	 */
	public Task() {
		super("task", models.generated.mysql.Tasks.TASKS);
	}
	...
	public Task(java.lang.String alias) {
		super(alias, models.generated.mysql.Tasks.TASKS, models.generated.mysql.tables.Task.TASK);
	}
	...
	public models.generated.mysql.tables.Task as(java.lang.String alias) {
		return new models.generated.mysql.tables.Task(alias);
	}
}
